...
class LoginForm extends Component {
  state = {
    email: `yuri${randomInt(0, 10000)}@ninjakitty.net`,
    password: 'password',
    name: 'thing',
    phone_number: 'thing',
    bank_name: 'thing',
    bank_routing_number: 'thing',
    bank_account_number: 'thing',
    phone_extension: 'thing',
    address_1: 'thing',
    address_2: 'thing',
    city: 'thing',
    state: 'thing',
  ...
  render() {
    const form = (
      <Form onSubmit={this.handleSubmit}>
        ...
        <Form.Input defaultValue={this.state.zip} label="zip" name="zip" onChange={this.handleChange} />
      </Form>
    )
